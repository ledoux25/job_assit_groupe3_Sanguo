...
comment on table besoins_realiser
is 'Differrent besoin_realise avaible';

comment on column besoins_realiser.besoin_realiser_id
is 'Auto-incrementation de la cle primaire';

comment on column besoins_realiser.note
is 'Note du besoin_realise';

comment on column besoins_realiser.commentaire
is ' Commentaire du besoin_realise';

comment on column besoins_realiser.candidature_id
