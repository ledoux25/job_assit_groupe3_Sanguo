...
comment on table besoin_realiser
is 'Differrent besoin_realise avaible';

comment on column besoin_realiser.besoin_realiser_id
is 'Auto-incrementation de la cle primaire';

comment on column besoin_realiser.note
is 'Note du besoin_realise';

comment on column besoin_realiser.commentaire
is ' Commentaire du besoin_realise';

comment on column besoin_realiser.candidature_id
